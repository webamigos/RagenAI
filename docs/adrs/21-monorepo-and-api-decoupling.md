...
**Status:** Partially implemented (monorepo merge + schema unification + Phase A + Phase B libs-only sub-scope, now including the basic-rag chain and the config/settings-resolution orchestration layer, done; Phase B chat-engine cutover and Phases C–D still pending)
**Date:** 2026-08-29
