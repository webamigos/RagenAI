...
areas: ['architecture']
topics: ['docker-compose', 'devcontainer', 'bind-mounts', 'local-development']
---
...
**Problem**: that mounts the wrong directory. Compose takes the _project directory_
...
The container would come up with the directory _containing_ the repository mounted at
...
`./infra/temporal/dynamicconfig`, and those keep resolving correctly _only_ because
...
relative to the _first_ file's directory, never to the file you are editing. Keep the
