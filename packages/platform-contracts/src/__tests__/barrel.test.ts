...
describe('the public entry point', () => {
  it.each([
    ...
    ['DEMO_FEATURE_OVERRIDES', 'object'],
    ['DEMO_MONTHLY_COST_LIMIT_CENTS', 'number'],
    ['DEMO_ORGANIZATION_RESTRICTIONS', 'object'],
    ...
    ['MCP_AUTH_TYPES', 'object'],
    ['OPERATOR_CREATABLE_AUTH_TYPES', 'object'],
    ['LEGACY_CATALOG_SLUGS', 'object'],
    ['isMcpAuthType', 'function'],
    ['isCatalogSlug', 'function'],
    ['catalogSlugError', 'function'],
    ['catalogCustomerSlug', 'function'],
    ['slugsCollide', 'function'],
