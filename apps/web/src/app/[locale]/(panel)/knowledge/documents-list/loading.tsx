 ...
 * one row holding search, the three filter chips and the view toggle, then the
 * table. There is no breadcrumb row at the root — a trail of one crumb names
 * the place the title already names — and the rail is 216px, not 224.
 */
  ...
  return (
    <div className="flex gap-3 pb-5">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        {/* Search, the three chips, and the view toggle at the far end. */}
