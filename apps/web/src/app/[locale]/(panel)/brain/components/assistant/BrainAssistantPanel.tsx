...
export function BrainAssistantPanel({
  ...
  return (
    <aside
      ...
      className="fixed inset-0 z-40 flex flex-col bg-background shadow-lg lg:inset-y-0 lg:left-auto lg:right-0 lg:z-30 lg:w-[var(--panel-width)] lg:border-l lg:border-border lg:shadow-none"
    >
