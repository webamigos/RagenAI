        ...
        {!isSharedView && canManageDocuments && (
          <>
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-border bg-white px-4 py-2 text-sm font-medium text-foreground shadow-sm hover:bg-muted transition-colors dark:bg-muted dark:hover:bg-paper-700"
            >
