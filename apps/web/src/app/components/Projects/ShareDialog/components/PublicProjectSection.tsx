          ...
          <div className="p-6 space-y-4">
            ...
            <div className="flex justify-end gap-2 pt-2">
              ...
              <button
                ...
                className="px-4 py-2 rounded text-sm text-primary-foreground bg-primary hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isRefreshing
