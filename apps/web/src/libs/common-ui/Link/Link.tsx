      ...
      <I18nLink href={href} passHref legacyBehavior>
        <a
          ...
          className={classMerge(
            ...
            variant === 'button'
              ? 'rounded-md bg-ragen-blue px-3.5 py-2.5 text-white shadow-xs hover:bg-brand-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-600'
              : '',
