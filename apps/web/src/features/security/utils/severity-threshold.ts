import type { SecurityEventSeverity } from '@/generated/prisma/client';
 ...
 * schema.prisma (`info < warn < critical`).
 */
 ...
 * to `critical`). Used by the record command to decide whether to fan a
 * newly-inserted event out to the email notifier.
 *
