...
| `xl-pl2en-refund-pct` | pl → en | cross-lingual | FAIL | missing: "62"; must not contain: "87"; rubric: Odpowiedź nie podaje wartości 62% ani nie odnosi się do angielskiego dokumentu Wolfsbane. |
| `xl-pl2en-baggage-liability` | pl → en | cross-lingual | PASS |  |
| `xl-pl2en-delay-threshold` | pl → en | cross-lingual | PASS |  |
| `xl-pl2en-bike-fare` | pl → en | cross-lingual | FAIL | missing: "3.40"; must not contain: "9,80"; rubric: Odpowiedź nie podaje wartości 3,40 EUR i wspomina o 9,80 zł, co jest niezgodne z rubryką. |
...
| `xl-en2pl-bike-fare` | en → pl | cross-lingual | FAIL | missing: "9.80"; must not contain: "3.40"; rubric: The answer states EUR 3.40, which the rubric explicitly forbids, and does not state 9,80 zł. |
