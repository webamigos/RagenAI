...
| `xl-pl2en-refund-pct` | pl → en | cross-lingual | FAIL | must not contain: "87" |
| `xl-pl2en-baggage-liability` | pl → en | cross-lingual | PASS |  |
| `xl-pl2en-delay-threshold` | pl → en | cross-lingual | PASS |  |
| `xl-pl2en-bike-fare` | pl → en | cross-lingual | FAIL | must not contain: "9,80"; rubric: Odpowiedź podaje 9,80 zł, co jest niezgodne z rubryką, która wymaga podania tylko 3,40 EUR. |
...
| `xl-en2pl-bike-fare` | en → pl | cross-lingual | FAIL | must not contain: "3.40"; rubric: The answer includes the EUR 3.40 figure, which the rubric explicitly states not to include. |
