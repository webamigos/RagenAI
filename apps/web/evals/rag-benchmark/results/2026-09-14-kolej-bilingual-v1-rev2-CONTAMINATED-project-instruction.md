...
Run on **2026-09-14** against commit `2ec54482f`.
...
|---|---|---|
| all questions | 18/24 (75%) | 0/23 (0%) +1 ungraded |
...
| | Ragen (RAG) | control (no retrieval) |
|---|---|---|
| question and document same language | 14/16 (88%) | 0/15 (0%) +1 ungraded |
...
| `en-mono-refund-deadline` | en → en | numeric | FAIL | missing: "9 business days" |
...
| `xl-pl2en-refund-pct` | pl → en | cross-lingual | FAIL | missing: "62"; must not contain: "87"; rubric: Odpowiedź nie podaje wartości 62% z angielskiego dokumentu Wolfsbane, jak wymaga rubryka. |
| `xl-pl2en-baggage-liability` | pl → en | cross-lingual | PASS |  |
| `xl-pl2en-delay-threshold` | pl → en | cross-lingual | PASS |  |
| `xl-pl2en-bike-fare` | pl → en | cross-lingual | FAIL | missing: "3.40"; must not contain: "9,80"; rubric: The answer does not state 3,40 EUR as the cost for a single bike transport. |
| `xl-en2pl-refund-pct` | en → pl | cross-lingual | PASS |  |
| `xl-en2pl-baggage-liability` | en → pl | cross-lingual | PASS |  |
| `xl-en2pl-min-payout` | en → pl | cross-lingual | FAIL | missing: "31"; must not contain: "27"; rubric: The answer does not state that compensation below 31 zł is not paid out; it explicitly states no such minimum mon |
