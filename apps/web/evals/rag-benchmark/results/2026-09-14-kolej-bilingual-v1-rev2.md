...
| `xl-pl2en-refund-pct` | pl → en | cross-lingual | FAIL | must not contain: "87"; rubric: Odpowiedź podaje wartość z polskiego regulaminu, co jest niezgodne z rubryką. |
...
| `xl-pl2en-bike-fare` | pl → en | cross-lingual | FAIL | missing: "3.40"; must not contain: "9,80"; rubric: Odpowiedź nie podaje wartości 3,40 EUR i zawiera wartość 9,80 zł, której nie powinno być. |
