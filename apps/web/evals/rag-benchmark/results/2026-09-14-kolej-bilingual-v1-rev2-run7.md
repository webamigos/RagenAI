...
|---|---|---|
| all questions | 19/24 (79%) | 0/23 (0%) +1 ungraded |
...
| `xl-pl2en-refund-pct` | pl → en | cross-lingual | FAIL | must not contain: "87"; rubric: The answer does not explicitly state that the 62% value comes from an English document. |
