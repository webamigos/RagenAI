...
Run on **2026-09-14** against commit `269b13422`.
...
|---|---|---|
| all questions | 18/23 (78%) +1 ungraded | 0/23 (0%) +1 ungraded |
...
| | Ragen (RAG) | control (no retrieval) |
|---|---|---|
| pl | 9/11 (82%) +1 ungraded | 0/12 (0%) |
| en | 9/12 (75%) | 0/11 (0%) +1 ungraded |

### Language of the document holding the answer

| | Ragen (RAG) | control (no retrieval) |
|---|---|---|
| pl | 8/11 (73%) +1 ungraded | 0/12 (0%) |
...
| | Ragen (RAG) | control (no retrieval) |
|---|---|---|
| question and document same language | 15/15 (100%) +1 ungraded | 0/15 (0%) +1 ungraded |
| cross-lingual | 3/8 (38%) | 0/8 (0%) |
...
| comparative | 1/1 (100%) +1 ungraded | 0/2 (0%) |
...
| `pl-mono-compare-deadlines` | pl → pl | comparative | UNGRADED | judge: judge returned unparseable JSON |
...
| `xl-pl2en-refund-pct` | pl → en | cross-lingual | FAIL | must not contain: "87"; rubric: The answer includes information from the Polish regulation, which the rubric explicitly forbids. |
...
| `xl-en2pl-refund-pct` | en → pl | cross-lingual | FAIL | must not contain: "62" |
...
| id | arm | why |
|---|---|---|
| `pl-mono-compare-deadlines` | rag | judge returned unparseable JSON |
