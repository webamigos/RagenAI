...
|---|---|---|
| all questions | 20/24 (83%) | 0/23 (0%) +1 ungraded |
...
| `xl-pl2en-bike-fare` | pl → en | cross-lingual | FAIL | missing: "3.40"; must not contain: "9,80"; rubric: The answer does not state 3,40 EUR as the cost for a single bike transport from the Wolfsbane document. |
...
| `xl-en2pl-bike-fare` | en → pl | cross-lingual | FAIL | must not contain: "3.40"; rubric: The answer mentions EUR 3.40, which the rubric explicitly states should not be included. |
