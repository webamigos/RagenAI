...
Run on **2026-09-14** against commit `e19088f76`.
...
|---|---|---|
| all questions | 17/24 (71%) | 0/23 (0%) +1 ungraded |
...
| `xl-pl2en-refund-pct` | pl → en | cross-lingual | FAIL | missing: "62"; must not contain: "87"; rubric: The answer does not state 62% and claims Wolfsbane documents do not specify the refund amount for voluntary cance |
...
| `xl-pl2en-bike-fare` | pl → en | cross-lingual | FAIL | missing: "3.40"; must not contain: "9,80"; rubric: Odpowiedź podaje 9,80 zł, podczas gdy rubryka wymaga 3,40 EUR i wyraźnie wyklucza 9,80 zł. |
