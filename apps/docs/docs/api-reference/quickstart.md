...
- **A running Ragen instance.** Ragen is self-hosted – see the
  [Quickstart](/docs/quickstart) if you don't have one yet. Everything below
...
```ts
import { RagenAuthError, RagenNotFoundError, RagenRateLimitError, RagenAPIError, RagenError } from '@webamigos/ragen-sdk-ts';
