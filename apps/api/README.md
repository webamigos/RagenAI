...
- **Runtime**: Node.js `^24.15.0 || >=26.0.0`

## Local Development

**Prerequisites**: Node.js `^24.15.0 || >=26.0.0` (see the root `AGENTS.md` for why it is a range), the shared infrastructure running (`docker compose up` at the repo root)
