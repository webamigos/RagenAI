import type { SecurityEventType } from '../generated/prisma/client.js';

/**
 * Ported verbatim from ragen-app's
 * src/features/security/utils/escalation-rules.ts. See
 * docs/adrs/21-monorepo-and-api-decoupling.md.
 *
 * Per-event-type burst thresholds used by SecurityEventService to
 * upgrade `severity` to `critical` when the same (userId, eventType) fires
 * repeatedly in a short window. This is how a trickle of benign `info`
 * events turns into a `critical` alert.
 *
