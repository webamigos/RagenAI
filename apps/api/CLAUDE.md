...
Google Drive folder import/sync and Fireflies transcript search (`ConnectorsModule`, ~1450 lines) remain unported — they need Temporal + S3 too, now that both exist in apps/api this is unblocked as a future slice, just not done in this one.
