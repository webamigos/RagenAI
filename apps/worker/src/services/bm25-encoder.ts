 ...
 *
 * Kept in sync with ragen-app/src/libs/vector-store/bm25-encoder.ts.
 */
...
export function tokenize(text: string): string[] {
  ...
  // NFKC normalization collapses visually-identical variants to a canonical form.
...
/**
 * Encode text to a BM25 sparse vector. Returns an empty vector for empty input —
 * callers should skip writing the sparse component when indices is empty.
 */
