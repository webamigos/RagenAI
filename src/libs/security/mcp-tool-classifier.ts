 ...
 * `src/libs/mcp/client.ts`: write tools get a `needsApproval` predicate
 ...
 * `wrapToolsForConnector` in `src/libs/mcp/client.ts` at registration time.
 */
 ...
 * `src/libs/mcp/provider-instructions.ts` when new write tools ship.
 */
