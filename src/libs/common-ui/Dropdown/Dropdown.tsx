  ...
  return (
    <Headless.MenuItems
      ...
      className={clsx(
        ...
        'overflow-y-auto',
        // Popover background
        'bg-white/75 backdrop-blur-xl dark:bg-accent-dark',
        // Shadows
...
>) {
  return (
    <Headless.MenuSeparator
      ...
      className={clsx(
        className,
        'col-span-full mx-3.5 my-1 h-px border-0 bg-slate-300 sm:mx-3 dark:bg-white/10 forced-colors:bg-[CanvasText]'
      )}
    />
  );
}
