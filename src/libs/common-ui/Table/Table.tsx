...
export function TableHeader({
  ...
  return (
    <th
      ...
      className={clsx(
        className,
        'border-b border-b-zinc-950/10 px-4 py-2 text-sm font-medium first:pl-[var(--gutter,theme(spacing.2))] last:pr-[var(--gutter,theme(spacing.2))] dark:border-b-white/10',
        grid &&
