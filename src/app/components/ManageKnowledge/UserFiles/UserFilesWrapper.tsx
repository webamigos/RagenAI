  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <div className="mb-3 flex shrink-0 items-center gap-3">
        ...
        <Dropdown>
          <DropdownButton className="inline-flex items-center gap-2 rounded-lg bg-violet-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-violet-700 transition-colors">
