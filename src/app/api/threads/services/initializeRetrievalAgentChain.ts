...
import { retrievalAgentChain } from '@/libs/chains/retrieval-agent-chain/chain';
...
const serviceName = 'initializeRetrievalAgentChain';
...
export const initializeRetrievalAgentChain = async ({
  settings,
  ...
  try {
    ...
    return await retrievalAgentChain({
      models: {
        contentModerator,
        questionRephraser,
        answerGenerator,
    ...
    logger.error({ err: error }, 'Error initializing retrieval agent chain');
    throw error;
  }
};
