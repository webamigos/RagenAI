...
-- CreateEnum
CREATE TYPE "FileType" AS ENUM ('UNKNOWN', 'TEXT', 'MARKDOWN', 'EPUB', 'PDF', 'SRT', 'URL', 'IMAGE', 'CSV', 'XLSX', 'DOCX');
...
-- CreateIndex
CREATE INDEX "document_permissions_file_id_idx" ON "document_permissions"("file_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "document_permissions_resource_type_file_id_grantee_type_gra_key" ON "document_permissions"("resource_type", "file_id", "grantee_type", "grantee_id");
...
-- AddForeignKey
ALTER TABLE "thread_documents" ADD CONSTRAINT "thread_documents_user_file_id_fkey" FOREIGN KEY ("user_file_id") REFERENCES "user_files"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "projects" ADD CONSTRAINT "projects_template_id_fkey" FOREIGN KEY ("template_id") REFERENCES "assistant_templates"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "document_permissions" ADD CONSTRAINT "document_permissions_file_id_fkey" FOREIGN KEY ("file_id") REFERENCES "user_files"("id") ON DELETE CASCADE ON UPDATE CASCADE;
